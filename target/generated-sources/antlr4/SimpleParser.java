...
public class SimpleParser extends Parser {
	...
	public final ExprContext expr() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(45); ((ExprContext)_localctx).NUM = match(NUM);
			...
			case 2:
				...
				setState(51); ((ExprContext)_localctx).t1 = term();
				setState(53);
				_la = _input.LA(1);
				if (_la==T__5) {
					{
				...
				setState(56); ((ExprContext)_localctx).t2 = term();
			...
			case 3:
				...
				setState(67); ((ExprContext)_localctx).m2 = expr();
			...
			case 4:
				...
				setState(73); ((ExprContext)_localctx).term = term();
				setState(75);
				_la = _input.LA(1);
				if (_la==T__5) {
					{
				...
				setState(78); ((ExprContext)_localctx).NUM = match(NUM);
			...
			case 5:
				...
				setState(84); ((ExprContext)_localctx).t1 = term();
				setState(86);
				_la = _input.LA(1);
				if (_la==T__5) {
					{
				...
				setState(89); ((ExprContext)_localctx).t2 = term();
			...
			case 6:
				...
				setState(95); ((ExprContext)_localctx).term = term();
				setState(97);
				_la = _input.LA(1);
				if (_la==T__5) {
					{
				...
				setState(100); ((ExprContext)_localctx).m4 = expr();
			...
			case 7:
				...
				setState(106); ((ExprContext)_localctx).NUM = match(NUM);
				setState(108);
			...
			case 8:
				...
				setState(114); ((ExprContext)_localctx).term = term();
				setState(116);
	...
	public final RepeatStmtContext repeatStmt() throws RecognitionException {
		...
		try {
			...
			setState(123); ((RepeatStmtContext)_localctx).expr = expr();
			setState(124); match(T__11);
			setState(125); ((RepeatStmtContext)_localctx).block = block();
		...
		try {
			...
			do {
				...
				case 1:
					{
					{
					setState(130); ((BlockContext)_localctx).stmt = stmt();
	...
	public final StmtContext stmt() throws RecognitionException {
		...
		try {
			...
			case T__7:
				enterOuterAlt(_localctx, 1);
				{
				setState(137); ((StmtContext)_localctx).printStmt = printStmt();
			...
			case T__8:
				enterOuterAlt(_localctx, 2);
				{
				setState(140); ((StmtContext)_localctx).assignStmt = assignStmt();
			...
			case T__1:
				enterOuterAlt(_localctx, 3);
				{
				setState(143); ((StmtContext)_localctx).repeatStmt = repeatStmt();
	...
	public final PrintStmtContext printStmt() throws RecognitionException {
		...
		try {
			...
			setState(150); ((PrintStmtContext)_localctx).exprList = exprList();
		...
		try {
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					{
					{
					setState(155); ((ExprListContext)_localctx).expr = expr();
			...
			setState(164); ((ExprListContext)_localctx).expr = expr();
			 _localctx.sExprList += ((ExprListContext)_localctx).expr.sExpr + ","; 
			}
		}
		catch (RecognitionException re) {
	...
	public final AssignStmtContext assignStmt() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(168); ((AssignStmtContext)_localctx).ID = match(ID);
				setState(169); match(T__10);
				setState(170); ((AssignStmtContext)_localctx).NUM = match(NUM);
			...
			case 2:
				...
				setState(173); ((AssignStmtContext)_localctx).ID = match(ID);
				setState(174); match(T__10);
				setState(175); ((AssignStmtContext)_localctx).expr = expr();
	...
	public final TermContext term() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(180); ((TermContext)_localctx).NUM = match(NUM);
			...
			case 2:
				...
				setState(187); ((TermContext)_localctx).NUM = match(NUM);
			...
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(190); ((TermContext)_localctx).f1 = factor();
				setState(191); match(T__4);
				setState(192); ((TermContext)_localctx).f2 = factor();
			...
			case 4:
				enterOuterAlt(_localctx, 4);
				{
				setState(195); ((TermContext)_localctx).factor = factor();
				setState(196); match(T__4);
				setState(197); ((TermContext)_localctx).t1 = term();
			...
			case 5:
				enterOuterAlt(_localctx, 5);
				{
				setState(200); ((TermContext)_localctx).NUM = match(NUM);
				setState(201); match(T__12);
				setState(202); ((TermContext)_localctx).factor = factor();
			...
			case 6:
				enterOuterAlt(_localctx, 6);
				{
				setState(205); ((TermContext)_localctx).factor = factor();
				setState(206); match(T__12);
				setState(207); ((TermContext)_localctx).NUM = match(NUM);
			...
			case 7:
				enterOuterAlt(_localctx, 7);
				{
				setState